      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 space-y-4 sm:space-y-8">
        ...
        {activeSlide && <div className="relative overflow-hidden rounded-3xl border-2 border-[#9B8B7E] bg-[#FDF6EE] shadow-xl sm:bg-[#FDF6EE]">
          <div className="group/gallery relative sm:h-[430px] lg:h-[500px]">
            ...
            />
            <div className="relative aspect-[16/10] overflow-hidden bg-[#FDF6EE] sm:hidden">
              <img
              ...
              />
              <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#FDF6EE]/50 via-transparent to-transparent" />
            </div>
            <img
              key={activeSlide?.src}
              src={activeSlide?.src}
            ...
            <div className="pointer-events-none relative z-30 p-8 sm:absolute sm:bottom-8 sm:left-8 sm:right-5 sm:max-w-xl sm:rounded-xl sm:border sm:border-[#D4A574]/30 sm:bg-[#4A3020]/85 sm:p-5 sm:shadow-xl sm:shadow-[#4A3020]/40 sm:backdrop-blur-md">
              <h2 className="text-3xl font-bold leading-tight text-[#3D2008] sm:text-white">{activeSlide?.title ?? activeSlide?.label}</h2>
              <p className="mt-5 text-base leading-8 text-[#6B4828] sm:mt-2 sm:text-base sm:leading-6 sm:text-[#D4C4A8]">
            ...
            <button
              ...
              className="absolute left-4 top-[29%] z-30 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-[#D4A574]/50 bg-[#4A3020]/80 text-[#D4A574] shadow-lg shadow-[#4A3020]/40 transition-colors hover:bg-[#D4A574]/25 sm:top-1/2 sm:h-12 sm:w-12"
            ...
            <button
              ...
              className="absolute right-4 top-[29%] z-30 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-[#D4A574]/50 bg-[#4A3020]/80 text-[#D4A574] shadow-lg shadow-[#4A3020]/40 transition-colors hover:bg-[#D4A574]/25 sm:top-1/2 sm:h-12 sm:w-12"
              aria-label="Next gallery slide"
            >
              <ChevronRight className="h-7 w-7" />
            </button>

            <div className="relative bottom-auto left-1/2 z-30 mb-8 flex w-fit -translate-x-1/2 gap-2 rounded-full border border-[#D4A574]/40 bg-[#4A3020]/70 px-3 py-2 sm:absolute sm:bottom-5 sm:mb-0">
